...
(function (global, factory) {
  ...
  var VERSION$8 = '4.1.3'; // why is DATA_KEY set to bs.scrollspy?

  var DATA_KEY$8 = 'bs.scrollspy';
  var EVENT_KEY$8 = "." + DATA_KEY$8;
  var DATA_API_KEY$6 = '.data-api';
  var JQUERY_NO_CONFLICT$8 = $.fn[NAME$8]; // set default constants for offset, method, and target

  var Default$6 = {
    offset: 10,
    method: 'auto',
    target: '' // set default types for offset, method, and target

  };
  var DefaultType$6 = {
    offset: 'number',
    method: 'string',
    target: '(string|element)' // set events for on() method

  };
  var Event$8 = {
    ACTIVATE: "activate" + EVENT_KEY$8,
    SCROLL: "scroll" + EVENT_KEY$8,
    LOAD_DATA_API: "load" + EVENT_KEY$8 + DATA_API_KEY$6 // set class names

  };
  var ClassName$8 = {
    DROPDOWN_ITEM: 'dropdown-item',
    DROPDOWN_MENU: 'dropdown-menu',
    ACTIVE: 'active' // set selectors
  ...
  var Selector$8 = {
    ...
    DROPDOWN_TOGGLE: '.dropdown-toggle' // set offset method for offset and position
  ...
  function () {
    function ScrollSpy(element, config) {
      ...
      this._element = element; // if element.tagName is equal to BODY, return window, otherwise return element
    ...
    _proto.refresh = function refresh() {
      ...
      var autoMethod = this._scrollElement === this._scrollElement.window ? OffsetMethod.OFFSET : OffsetMethod.POSITION; // if config.method is equal to auto, return autoMethod, otherwise return
      // config.method. --> What is this._config.method referring to?

      var offsetMethod = this._config.method === 'auto' ? autoMethod : this._config.method; // if offsetMethod is equal to POSITION, return vertical position, otherwise
      // return 0

      var offsetBase = offsetMethod === OffsetMethod.POSITION ? this._getScrollTop() : 0; // set _offsets and _targets as empty arrays

      this._offsets = [];
      this._targets = []; // set scrollHeight to scrollHeight or minimum height element would require to fit
      // in viewport without using a vertical scrollbar

      this._scrollHeight = this._getScrollHeight(); // create an array called targets that includes all of the nav links, list items,
      // and dropdown items

      var targets = [].slice.call(document.querySelectorAll(this._selector)); // map, filter, sort, and forEach? targets array --> Not exactly sure what this is doing?
    ...
    ScrollSpy._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        var _config = typeof config === 'object' && config; // if no data, define new data
